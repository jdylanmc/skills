...
The package may be installed at `.github/skills/roast-this-prompt/` or
`~/.agents/skills/roast-this-prompt/`. It resolves the coordinator and every coach agent
...
```bash
shasum -a 256 skills/roast-this-prompt/references/30-trusted-lenses.md
```
