...
1. **Spawn.** Use [Agent spawn](../../_atoms/agent-spawn/agent-spawn.md) with the coach
...
3. **Validate.** Use
   [Review validate report](../../_atoms/review-validate-report/review-validate-report.md) with the STE
