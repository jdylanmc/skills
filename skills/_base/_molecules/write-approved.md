...
level: molecule
includes: ["_base/_atoms/approval-gate-mutation.md","_base/_atoms/write-verified.md"]
---
...
1. [Approval gate for a mutation](../_atoms/approval-gate-mutation.md)
2. [Verified write](../_atoms/write-verified.md)
...
1. **Observe** the destination's current content, or its absence, and keep it as
   the preview state.
2. **Gate** with [Approval gate for a mutation](../_atoms/approval-gate-mutation.md),
...
3. **Write** with [Verified write](../_atoms/write-verified.md), passing the
