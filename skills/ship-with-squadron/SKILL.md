...
2. [Run ledger and state machine](./references/20-run-ledger-and-state.md)
3. [Backlog hydration and scheduling](./references/30-backlog-and-scheduling.md)
4. [Worker lifecycle and composed skills](./references/40-worker-lifecycle.md)
...
2. Create or resume the durable run ledger. Reconcile it with live tracker,
   branch, pull-request, review, and check state before starting agents.
...
1. verify every fact against the named fresh ledger or provider snapshot;
...
through prompts and ledger validation. Every use remains bounded by the role
