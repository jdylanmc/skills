...
package it applies when the reviewed prompt actually defines such a workflow
and should be rerouted.

Artifact scope for this package is set by
[Prompt roast contract](./10-prompt-roast-contract.md), which supersedes this
