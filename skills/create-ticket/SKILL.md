...
Constraint: Do not publish, comment on, label, close, or otherwise mutate any tracker item. Do not read or search code to investigate root cause. Do not execute, implement, or claim any ticket. Formatting is the entire job.
